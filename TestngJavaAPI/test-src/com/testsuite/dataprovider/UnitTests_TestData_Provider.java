...
public class UnitTests_TestData_Provider {
	...
	@DataProvider(name = "TC016_UpdateTravelerDetails")
	public static String[][] TC016_UpdateTravelerDetails(){
		
		ExcelManager excel = null;
		excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator + "Booking" + fileSeparator + "UpdateTravelerDetails" + fileSeparator + "TC016_UpdateTravelerDetails.xlsx");
	...
	@DataProvider(name = "TC010_UpdateBookerDetails")
	public static String[][] TC010_UpdateBookerDetails(){
		
		ExcelManager excel = null;
		excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator + "Booking" + fileSeparator + "UpdateBookerDetails" + fileSeparator + "TC010_UpdateBookerDetails.xlsx");
	...
	@DataProvider(name = "TC010_ProcessPaymentAndCreateBooking")
	public static String[][] TC010_ProcessPaymentAndCreateBooking(){
		
		ExcelManager excel = null;
		excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator + "Booking" + fileSeparator + "ProcessPaymentAndCreateBooking" + fileSeparator + "TC010_ProcessPaymentAndCreateBooking.xlsx");
